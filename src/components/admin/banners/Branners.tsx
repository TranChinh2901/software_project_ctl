...
export default function Banners() {
  ...
  const activeBanners = banners.filter(b => b.status === BannerType.ACTIVE).length;
        ...
        <Card className={styles.statCard}>
          <div className={styles.statContent}>
            ...
            <div className={styles.statInfo}>
              <div className={styles.statLabel}>Tổng Banner</div>
              <div className={styles.statValue}>{totalBanners}</div>
            </div>
          </div>
        </Card>
        ...
        <Card className={styles.statCard}>
          <div className={styles.statContent}>
            ...
            <div className={styles.statInfo}>
              ...
              <div className={styles.statValue}>{activeBanners}</div>
            </div>
          </div>
        </Card>
      </div>
